...
class CustomerRegistrationForm(UserCreationForm):
    ...
    password2 = forms.CharField(label= 'Confirm Password (again)', widget=forms.PasswordInput(attrs={'class':'form'
                                          '-control','placeholder':'Please Enter Your Password Again'}))
    email = forms.CharField(required = True, widget= forms.EmailInput(attrs = {'class':'form-control'
                            ,'placeholder':'Please Enter Your Valid E-mail Id'}))
...
class LoginForm(AuthenticationForm):
    ...
    {'autofocus': True, 'class': 'form-control','placeholder':'Please Enter Your Username'}))
    password = forms.CharField(label=_("Password"), strip=False,widget=forms.PasswordInput(attrs=
    {'autocomplete': 'current-password', 'class': 'form-control','placeholder':'Please Enter Your Password'}))
